...
PROJECT = {"analysis_type": "rebalancing", "asset_columns": ["equity_return", "bond_return", "alt_return"], "category": "Portfolio Optimization & Allocation", "columns": ["date", "equity_return", "bond_return", "alt_return"], "methods": ["월별 수익률로 보유 비중을 drift시킨 뒤 목표비중 이탈이 밴드를 넘으면 리밸런싱한다.", "회전율과 거래비용을 명시해 단순 성과 비교의 과대평가를 피한다.", "수익률 표본은 구조 설명용 합성 데이터다."], "module_name": "rebalancing_baseline", "objective": "목표 가중치와 허용 밴드가 거래 횟수, 비용, 누적성과에 미치는 영향을 계산한다.", "question": "고정 주기보다 밴드 기반 리밸런싱이 거래비용과 추적오차를 어떻게 절충하는가?", "rebalance_band": 0.05, "rows": [["2025-09", 0.026, -0.004, 0.01], ["2025-10", -0.018, 0.006, 0.004], ["2025-11", 0.031, 0.002, -0.006], ["2025-12", 0.007, 0.005, 0.012], ["2026-01", -0.025, 0.011, -0.002], ["2026-02", 0.019, -0.003, 0.006]], "sample_name": "monthly_asset_returns.csv", "target_weights": [0.55, 0.3, 0.15], "title_en": "Portfolio Rebalancing Strategy", "title_ko": "포트폴리오 리밸런싱 전략", "transaction_cost": 0.001}
